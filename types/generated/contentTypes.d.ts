...
export interface ApiPropertyProperty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categories: Attribute.Relation<
      ...
      'api::category.category'
    >;
    propertyType: Attribute.Enumeration<['none', 'popular', 'destacado']> &
      Attribute.DefaultTo<'none'>;
    propertyFeature: Attribute.Component<
    ...
    types: Attribute.Relation<
      ...
      'api::type.type'
    >;
    ubications: Attribute.Relation<
      'api::property.property',
      'manyToMany',
      'api::ubication.ubication'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiUbicationUbication extends Schema.CollectionType {
  collectionName: 'ubications';
  info: {
    singularName: 'ubication';
    pluralName: 'ubications';
    displayName: 'Ubication';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    nameubication: Attribute.String;
    properties: Attribute.Relation<
      'api::ubication.ubication',
      'manyToMany',
      'api::property.property'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::ubication.ubication': ApiUbicationUbication;
    }
  }
}
